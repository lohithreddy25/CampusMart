...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[70px] bg-black text-white z-50 flex items-center shadow-md">
            <div className="flex items-center justify-between w-full max-w-screen-2xl mx-auto px-4">
                <Link to="/" className="flex items-center text-2xl font-bold">
                    <FaStore className="mr-2 text-3xl"/>
                    <span className="font-[Poppins]">OUR-STORE</span>
                </Link>
                ...
                {/* <button
                    ...
                    className= "sm:hidden flex items-center sm:mt-0 mt-2">
                        {navbarOpen ?(
                            <Cross2Icon className= "text-white text-3xl"/>
                        ) : (
